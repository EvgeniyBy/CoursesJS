...
document.querySelector(".setting .manager .add").addEventListener("click",
    function(){
        let fname = document.querySelector(".setting .manager .fname").value;
        let lname = document.querySelector(".setting .manager .lname").value;
        let many = document.querySelector(".setting .manager .many").value;
        let experience = document.querySelector(".setting .manager .experience").value;
...
document.querySelector(".setting .developer .add").addEventListener("click",
    function(){
        let fname = document.querySelector(".setting .developer .fname").value;
        let lname = document.querySelector(".setting .developer .lname").value;
        let many = document.querySelector(".setting .developer .many").value;
        let select = document.querySelector(".setting .developer .level");
...
document.querySelector(".setting .project .add").addEventListener("click",
    function(){
        let name = document.querySelector(".setting .project .name").value;
        let cost = document.querySelector(".setting .project .cost").value;
        let stringCode = document.querySelector(".setting .project .stringCode").value;
        let maxDev = document.querySelector(".setting .project .maxDev").value;
